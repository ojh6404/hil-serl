...
from serl_robot_infra.utils.rotations import euler_2_quat, quat_2_euler
...
class DefaultEnvConfig:
    ...
    ACTION_SCALE: np.ndarray = np.zeros((3,))
...
if __name__ == "__main__":
    ...
    # from serl_robot_infra.pr2_env.envs.wrappers import SpacemouseIntervention
    from serl_robot_infra.robots.wrappers.env_wrapper import SpacemouseIntervention
   
    default_config = DefaultEnvConfig()
    default_config.ACTION_SCALE = np.array([0.1, 0.3, 1.0])
    default_config.RESET_POSE = np.array([0.5, 0.1, 0.75, 0, 0, 0])
