...
flags.DEFINE_string("data_path", None, "Path to classifier data.")
...
def main(_):
    ...
    success_paths = glob.glob(os.path.join(FLAGS.data_path, "*success*.pkl"))
    print("Reading success data from: ", success_paths)
    ...
    failure_paths = glob.glob(os.path.join(FLAGS.data_path, "*failure*.pkl"))
